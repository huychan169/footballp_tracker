...
try:
    from DetectTrack.BotSort.fast_reid.fast_reid_interfece import FastReIDInterface
except ImportError:
    FastReIDInterface = None

# try:
from DetectTrack.BotSort.reid.torchreid_interface import TorchreIDInterface
# except ImportError:
